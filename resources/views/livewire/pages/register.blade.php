                   ...
                   <div class="col-xl-6 col-lg-8">
                       <div class="eg-login__wrapper">
                           <div class="eg-login__top text-center mb-30">
                               <h3 class="eg-login__title">Sing Up.</h3>
                               <p>Already have an account? <span><a href="{{ route('shop.login') }}">Sign In</a></span>
                               </p>
                           </div>
                           <form wire:submit.prevent="register" class="eg-login__option">
                               <div class="eg-login__input-wrapper">
                                   ...
                                   <div class="eg-login__input-box">
                                       <div class="eg-login__input">
                                           ...
                                           <input id="eg-password__input" wire:model="password" type="password"
                               ...
                               <div
                                   class="eg-login__suggetions d-flex align-items-center justify-content-between mb-20">
                                   <div class="eg-login__remeber">
                                       <input id="remeber" wire:model.live="remember" type="checkbox">
