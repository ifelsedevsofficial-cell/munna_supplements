<main class="fix">
                ...
                <div class="col-lg-12">
                    <div class="eg-banner__wrap mt-70">
                        ...
                        <div class="eg-banner__thumb d-flex justify-content-center">
                            ...
                            <div class="eg-banner__thumb-2"><img src="assets/img/banner/banner-img-2.png"
                                    alt="banner-thumb"></div>
                            <div class="eg-banner__thumb-3"><img class="layer" data-depth="0.2"
                                    src="{{ asset('assets/img/banner/banner-img-3.png') }}" alt="banner-thumb"></div>
                        </div>
                        <div class="eg-banner__content">
                            <h3 class="title">supex Increase your Energy</h3>
                            <div class="eg-banner__btn">
                                <a class="eg-btn" href="{{ route('shop') }}">View all Supplements<span><i
    ...
    <section class="about__area eg-about__bg scene">
            ...
            <div class="row align-items-center">
                <div class="col-xl-6 col-lg-6 mb-40">
                    <div class="eg-about__thumb w-img">
                        <img src="{{ asset('assets/img/about/about-01.png') }}" alt="about-thumb">
                    </div>
                </div>
                <div class="col-xl-5 col-lg-6 mb-40">
                    <div class="eg-about__wrapper">
                        <div class="eg-about__content">
                            <h4 class="eg-about__title">Supplement Formulas Features of the most favorite Flavor
                            </h4>
                            <p>Our supplements are meticulously formulated with a focus on quality, efficacy, and
                                innovation, ensuring that you receive the best possible results.</p>
                        </div>
                        ...
                        <span>Our supplements are meticulously formulated with a focus on quality, efficacy, and
                            innovation.</span>
                        <div class="eg-about__btn">
                            <a class="eg-btn" href="{{ route('shop') }}">Shop Now <span><i
                                        class="fa-solid fa-chevron-right"></i></span></a>
                            <a class="eg-btn about-btn" href="{{ route('shop.contact') }}">Contact Us <span><i
                                        class="fa-solid fa-chevron-right"></i></span></a>
                        </div>
                    </div>
                </div>
        ...
        <div class="eg-about__shape-1">
            <img class=" layer" data-depth="0.3" src="{{ asset('assets/img/about/about-shape-1.png') }}"
                alt="about-shape">
        </div>
        <div class="eg-about__shape-2 scene-y">
            <img class=" layer" data-depth="3" src="{{ asset('assets/img/about/about-shape-2.png') }}"
                alt="about-shape">
        </div>
    </section>
    <!-- about area area -->
    ...
    @foreach ($categories as $category)
        <x-sections.home.product-area :category="$category" />
    @endforeach
    ...
    <section class="feature__area eg-feature__bg theme-bg scene">
                            ...
                            <div class="eg-feature__shape">
                                <div class="eg-feature__shape-1">
                                    <img class="layer" data-depth="0.4"
                                        src="{{ asset('assets/img/feature/feature-shape-01.png') }}"
                                        alt="feature-shape">
                                </div>
                                <div class="eg-feature__shape-2">
                                    <img class="layer" data-depth="0.4"
                                        src="{{ asset('assets/img/feature/feature-shape-02.png') }}"
                                        alt="feature-shape">
                                </div>
                            </div>
                        </div>
        ...
        <div class="eg-feature__shape">
            <div class="eg-feature__shape-3 scene-y">
                <img class="layer" data-depth="3" src="{{ asset('assets/img/feature/feature-shape-03.png') }}"
                    alt="feature-shape">
            </div>
            <div class="eg-feature__shape-4">
                <img class="layer" data-depth=".4" src="{{ asset('assets/img/feature/feature-shape-04.png') }}"
                    alt="feature-shape">
            </div>
            <div class="eg-feature__shape-5">
                <img class="layer" data-depth=".3" src="{{ asset('assets/img/feature/feature-shape-04.png') }}"
                    alt="feature-shape">
            </div>
            <div class="eg-feature__shape-6 scene-y">
                <img class="layer" data-depth="3" src="{{ asset('assets/img/feature/feature-shape-01.png') }}"
                    alt="feature-shape">
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="eg-pricing__wrapper">
                        ...
                        <div class="eg-pricing__item">
                            <div class="eg-pricing__head-shadow">
                                <div class="eg-pricing__head">
                                    ...
                                    <div class="eg-pricing__shape">
                                        <img src="{{ asset('assets/img/price/peice-shape-01.png') }}"
                                            alt="price-shape">
                                    </div>
                                </div>
                            </div>
                            <div class="eg-pricing__list">
                                <ul>
                                    ...
                                    <li class="inactive"><span><i class="fas fa-check-circle"></i></span>80
                                        Capsules
                                        Per Bottle</li>
                                </ul>
                            </div>
                        ...
                        <div class="eg-pricing__item pri-active">
                            ...
                            <div class="eg-pricing__list">
                                <ul>
                                    ...
                                    <li class="inactive"><span><i class="fas fa-check-circle"></i></span>100
                                        Capsules
                                        Per Bottle</li>
                                </ul>
                            </div>
                ...
                <div class="eg-pricing__shape-1">
                    <img class="layer" data-depth="0.3" src="{{ asset('assets/img/price/peice-shape-02.png') }}"
                        alt="pricing-shape">
                </div>
                <div class="eg-pricing__shape-2">
                    <img class="layer" data-depth="0.2" src="{{ asset('assets/img/price/peice-shape-03.png') }}"
                        alt="pricing-shape">div>
                </div>
            </div>
    </section>
    <!-- pricing area end -->
 --}}
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseTwo" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            <p>Our supplement is carefully formulated to provide
                                                comprehensive
                                                support
                                                for your health and wellness needs. It combines a unique
                                                blend of
            ...
            <div class="eg-testimonial__wrap">
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide eg-testimonial__item text-center">
                                    <div class="eg-testimonial__avatar-thumb">
                                        <img src="{{ asset('assets/img/testimonial/testimonial-thumb-01.png') }}"
                                    ...
                                    <div class="eg-testimonial__content">
                                        <p> "I have been using the clean gainer Multivitamin Supplement for several
                                            months now, and I am thrilled with the results. Not only has it boosted
                                            my
                                            energy levels, but it has also improved my overall well-being. I feel
                                            more
                                            focused, my immune system”</p>
                                    </div>
                                    <div class="eg-testimonial__rating">
                                        <span><img src="{{ asset('assets/img/icon/star.svg') }}"
                ...
                <div class="eg-testimonial__arrow">
                    <div class="eg-testimonial__next">
                        <span><svg width="21" height="16" viewBox="0 0 21 16" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M20.7071 8.70711C21.0976 8.31658 21.0976 7.68342 20.7071 7.2929L14.3431 0.928933C13.9526 0.538409 13.3195 0.538409 12.9289 0.928933C12.5384 1.31946 12.5384 1.95262 12.9289 2.34315L18.5858 8L12.9289 13.6569C12.5384 14.0474 12.5384 14.6805 12.9289 15.0711C13.3195 15.4616 13.9526 15.4616 14.3431 15.0711L20.7071 8.70711ZM-8.74228e-08 9L20 9L20 7L8.74228e-08 7L-8.74228e-08 9Z"
                                    fill="currentColor" />
                    ...
                    <div class="eg-testimonial__prev">
                        <span><svg width="22" height="16" viewBox="0 0 22 16" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M1.04083 7.18205C0.650309 7.57258 0.650309 8.20574 1.04083 8.59627L7.40479 14.9602C7.79532 15.3508 8.42848 15.3508 8.81901 14.9602C9.20953 14.5697 9.20953 13.9365 8.81901 13.546L3.16215 7.88916L8.81901 2.23231C9.20953 1.84178 9.20953 1.20862 8.81901 0.818092C8.42848 0.427568 7.79532 0.427568 7.40479 0.818092L1.04083 7.18205ZM21.5183 6.88916L1.74794 6.88916V8.88916L21.5183 8.88916V6.88916Z"
                                    fill="currentColor" />
        ...
        <div class="eg-testimonial__shape">
            <div class="eg-testimonial__shape-1 scene-y">
                <img class="layer" data-depth="3"
                    src="{{ asset('assets/img/testimonial/testimonial-shape-03.png') }}" alt="testimonial-shape">
            </div>
            <div class="eg-testimonial__shape-2 scene-y">
                <img class="layer" data-depth="3"
                    src="{{ asset('assets/img/testimonial/testimonial-shape-04.png') }}" alt="testimonial-shape">
            </div>
            <div class="eg-testimonial__shape-3 scene-y">
                <img class="layer" data-depth="3"
                    src="{{ asset('assets/img/testimonial/testimonial-shape-05.png') }}" alt="testimonial-shape">
            </div>
    ...
    <section class="blog__area eg-blog__bg scene">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="eg-blog__item text-center mb-40">
                        <div class="eg-blog__thumb w-img">
                            <a href=""><img src="{{ asset('assets/img/blog/blog-thumb-01.jpg') }}"
                                    alt="img"></a>
                        </div>
                        <div class="eg-blog__content">
                            ...
                            <h4 class="eg-blog__title"><a href="blog-details.html">hOW MUCH DO EAT YOU REALLY <br>
                                    NEED supplements</a></h4>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="eg-blog__item text-center mb-40">
                        <div class="eg-blog__thumb w-img b-mask-2">
                            <a href="blog-details.html"><img src="{{ asset('assets/img/blog/blog-thumb-02.jpg') }}"
                                    alt="img"></a>
                        </div>
                        <div class="eg-blog__content">
                            <div class="eg-blog__meta-date">
                            ...
                            <h4 class="eg-blog__title"><a href="blog-details.html">The Ultimate Christmas Gift <br>
                                    Guide for Car Lovers</a></h4>
                            <div class="eg-blog__meta-name">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="eg-blog__item text-center mb-40">
                        <div class="eg-blog__thumb w-img">
                            <a href="blog-details.html"><img src="{{ asset('assets/img/blog/blog-thumb-03.jpg') }}"
                                    alt="img"></a>
                        </div>
                        <div class="eg-blog__content">
                            <div class="eg-blog__meta-date">
                            ...
                            <h4 class="eg-blog__title"><a href="">Can breakfast and Nutrition <br>
                                    help keep us thin?</a></h4>
                            <div class="eg-blog__meta-name">
                            ...
                            <a href="index.html#product">
                                <span>
                                    <svg width="16" height="17" viewBox="0 0 16 17" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M8.70711 0.292892C8.31658 -0.0976315 7.68342 -0.0976314 7.29289 0.292892L0.928932 6.65685C0.538407 7.04738 0.538407 7.68054 0.928932 8.07107C1.31946 8.46159 1.95262 8.46159 2.34315 8.07107L8 2.41421L13.6569 8.07107C14.0474 8.46159 14.6805 8.46159 15.0711 8.07107C15.4616 7.68054 15.4616 7.04738 15.0711 6.65685L8.70711 0.292892ZM9 17L9 1L7 1L7 17L9 17Z"
                                            fill="#000D44" />
                                    </svg>
                                </span>
                            </a>
        ...
        <div class="eg-blog__shape-1">
            <img class="layer" data-depth="0.3" src="{{ asset('assets/img/blog/blog-shape-1.png') }}"
                alt="blog-shape">
        </div>
        <div class="eg-blog__shape-2">
            <img class="layer" data-depth="0.3" src="{{ asset('assets/img/blog/blog-shape-2.png') }}"
                alt="blog-shape">
        </div>
    </section>
    <!-- blog area end --> --}}
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="eg-instagram__item mask-1 mb-40">
                                    <img src="{{ asset('assets/img/instagram/instagram-1.png') }}" alt="">
                                    <div class="eg-instagram__icon">
                                        <a class="popup-image"
                                            href="{{ asset('assets/img/instagram/instagram-1.png') }}"><i
                            ...
                            <div class="swiper-slide">
                                <div class="eg-instagram__item mask-2 mb-40">
                                    <img src="{{ asset('assets/img/instagram/instagram-2.png') }}" alt="">
                                    <div class="eg-instagram__icon">
                                        <a class="popup-image"
                                            href="{{ asset('assets/img/instagram/instagram-2.png') }}"><i
                                                class="fab fa-instagram"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="eg-instagram__item mask-3 mb-40">
                                    <img src="{{ asset('assets/img/instagram/instagram-3.png') }}" alt="">
                                    <div class="eg-instagram__icon">
                                        <a class="popup-image"
                                            href="{{ asset('assets/img/instagram/instagram-3.png') }}"><i
                                                class="fab fa-instagram"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="eg-instagram__item mask-4 mb-40">
                                    <img src="{{ asset('assets/img/instagram/instagram-4.png') }}" alt="">
                                    <div class="eg-instagram__icon">
                                        <a class="popup-image"
                                            href="{{ asset('assets/img/instagram/instagram-4.png') }}"><i
                                                class="fab fa-instagram"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="eg-instagram__item mask-5 mb-40">
                                    <img src="{{ asset('assets/img/instagram/instagram-5.png') }}" alt="">
                                    <div class="eg-instagram__icon">
                                        <a class="popup-image"
                                            href="{{ asset('assets/img/instagram/instagram-5.png') }}"><i
                                                class="fab fa-instagram"></i></a>
                                    </div>
                                </div>
                            </div>
